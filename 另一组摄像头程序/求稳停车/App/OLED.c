...
/************************************************************************
     OLED 一行可以显示16个字符，可以显示8行。
         ...
         gpio_init (PTD4, GPO,LOW);
************************************************************************/

  #define OLED_SCL      PTD3_OUT                  // PTA15_OUT
  #define OLED_SDA      PTD1_OUT                  //PTA17_OUT
  #define OLED_RST      PTC15_OUT                 //PTA19_OUT
  #define OLED_DC       PTD2_OUT                  //PTA16_OUT
  #define OLED_CS       PTD4_OUT                  //PTA14_OUT
