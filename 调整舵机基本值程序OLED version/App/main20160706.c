...
void  main(void)
{
    ...
    while(1)
    {
        ...
        if(slope.left_count>slope.right_count)
            actuator_pid.pv = (int)(slope.left*1000 - duoji)*10000;
        else if(slope.left_count<slope.right_count)
            actuator_pid.pv = (int)(slope.right*1000 - duoji)*10000;
        else
            actuator_pid.pv = 0;
        ...
        smart_control_actuator(-(float)actuator_pid.pv/10000, g_fSpeed_control_out_L, g_fSpeed_control_out_R);
        printf("actuator_pid.pv:%d,duoji:%d\n",(int)actuator_pid.pv,(int)duoji);
