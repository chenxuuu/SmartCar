...
uint8 imgsee[60][80];                             //定义存储接收图像的数组
uint8 imgoled[600];
...
//        }
        ...
        //Display_number(0,4,solvecount(0,40,26,59));     Display_number(41,4,solvecount(26,40,52,59));           Display_number(82,4,solvecount(52,40,79,59));
                                                        ...
                                                        Display_number(41,7,solvecount(52,20,79,40)-solvecount(0,20,26,40));

        //control_actuator(-((float)solvecount(52,20,79,40)-(float)solvecount(0,20,26,40)/*+(float)solvecount(52,0,79,20)-(float)solvecount(0,0,26,20)*/)/10);
