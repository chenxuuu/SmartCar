...
uint8 blackl;
int8  shizi;   
float left[97]=  { -65,-65,-64,-64,-64,-63,-63,-63,-62,-62,-62,-62,-61,
                    -61,-61,-60,-60,-60,-59,-59,-59,-58,-58,-58,-57,-57,
                    -57,-56,-56,-56,-55,-55,-54,-54,-54,-53,-53,-53,-52,
                    -52,-51,-51,-51,-50,-50,-50,-49,-49,-48,-48,-47,-47,
                    -47,-46,-46,-45,-45,-44,-44,-43,-43,-43,-42,-42,-41,
                    -41,-40,-40,-39,-39,-38,-38,-37,-37,-36,-36,-35,-35,
                    -34,-34,-33,-33,-32,-32,-31,-31,-30,-30,-29,-29,-28,
                    -28,-27,-26,-26
};
float right[97]=  { 67,67,66,66,66,65,65,65,64,64,64,63,63,63,62,62,62,
                     61,61,61,60,60,59,59,59,58,58,58,57,57,56,56,56,55,
                     55,54,54,53,53,53,52,52,51,51,50,50,50,49,49,48,48,
                     47,47,47,46,46,45,45,44,44,43,43,42,42,42,41,41,40,
                     40,39,39,38,38,37,37,36,36,35,35,34,34,33,33,32,32,
...
//OLED_P6x8Str(0,4,"biao:");
//Display_number(30,4,biaozhi_3);
...
void judge_zxst()
{
  int16 j; 
  int16 zx1,zx2,zx3;
  if((left_diuxian1>50)||(right_diuxian1>50))    //判断是否为中心引导线
        {
        ...
        for(j=0;j<160;j++)
	 {
        ...
        zxyd=0;    
        if((right_bianjie[15]!=zx1)&&(right_bianjie[20]!=zx2)&&(right_bianjie[30]!=zx3))
          zxyd=1;
         }
        else
        {
        ...
        for(j=159;j>0;j--)
	 {
        ...
        if((left_bianjie[15]!=zx1)&&(left_bianjie[20]!=zx2)&&(left_bianjie[30]!=zx3))
          zxyd=1;
        }
        }
}
...
if(((diuxian>5)||(diuxian2>60))&&((diuxian2!=right_diuxian1)&&(diuxian2!=left_diuxian1)))
{
   ...
   {
     if/*((infl_l>infl_r)&&*/(left_diuxian1<right_diuxian1)
     {
    ...
    else //if((infl_l<infl_r)&&(left_diuxian1>right_diuxian1))
    {
...
void obsta(char left_diuxian,char right_diuxian)
{
  ...
  {
    diuxian_r=(right_diuxian-(60-hight));
    diuxian_l=(left_diuxian-(60-hight));     
  }
       ...
       if(shizi==0)
	{
         ...
         {                       
          ...
          obsta(left_diuxian,right_diuxian);//障碍
             ...
             if((((x/100)>1800)||(dbsj==1))&&(biaozhi_3==0))     //260
                {
                xielv=x/y;
                if(xielv>15)	xielv=xielv-15;
                if(xielv<-15)	xielv=xielv+15;
                }
              else
              {
