...
void initkey()
{
 gpio_init(PTD11,GPI,0);                      //初始化   管脚为输入  初始状态为低电平
 gpio_init(PTD12,GPI,0);                      //初始化   管脚为输入  初始状态为低电平
 gpio_init(PTD13,GPI,0);                      //初始化   管脚为输入  初始状态为低电平
 gpio_init(PTD14,GPI,0);                      //初始化   管脚为输入  初始状态为低电平
 gpio_init(PTD15,GPI,0);                      //初始化   管脚为输入  初始状态为低电平
 gpio_init(PTE0,GPI,0);                      //初始化   管脚为输入  初始状态为低电平
gpio_init(PTE1,GPI,0);                      //初始化   管脚为输入  初始状态为低电平
 gpio_init(PTE2,GPI,0);                      //初始化   管脚为输入  初始状态为低电平
 gpio_init(PTE28,GPI,0);                      //初始化   管脚为输入  初始状态为低电平
